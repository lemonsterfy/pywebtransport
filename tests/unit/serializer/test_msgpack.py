...
class TestMsgPackSerializer:
    ...
    def test_deserialize_with_unpack_kwargs(self, mocker: Any) -> None:
        from pywebtransport.serializer.msgpack import MsgPackSerializer
    ...
    def test_initialization_fails_if_msgpack_is_not_installed(self, mocker: Any) -> None:
        from pywebtransport.serializer.msgpack import MsgPackSerializer
    ...
    def test_serialize_with_pack_kwargs(self, mocker: Any) -> None:
        from pywebtransport.serializer.msgpack import MsgPackSerializer
