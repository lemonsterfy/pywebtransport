...
- **`def create_quic_configuration(*, alpn_protocols: list[str], congestion_control_algorithm: str, idle_timeout: float, is_client: bool, max_datagram_size: int) -> QuicConfiguration`**: Creates a QUIC configuration from specific, required parameters.
...
- **`def generate_self_signed_cert(*, hostname: str, output_dir: str = ".", days_valid: int = 365, key_size: int = 2048) -> tuple[str, str]`**: Generates a self-signed certificate and private key for testing purposes.
